...
export const Jetisu = (props) => {
  return (
    <div className="   bg-black w-full h-[3300px] z-50 ">
      {props.children}
      <div
      ...
      <div className="">
        ...
        <Footer className=" absolute mt-[3184px] ml-[518px]    " />
      </div>

      {/* <div className="absolute mt-[50px]">
        <img src={caseNavbar} />

        <div className="  text-white mt-[-1570px] font-bold text-[65px] ml-[110px]">
          Кейсы
        </div>
      </div> */}
    </div>
