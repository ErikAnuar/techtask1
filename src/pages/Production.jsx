...
export const Production = (props) => {
  ...
  return (
    <div className="relative bg-black w-full h-[950px] overflow-hidden">
        ...
        <div className={videoWrapperClasses}>
          ...
          <button
            ...
            style={{
              ...
              zIndex: 999,
              ...buttonStyles, // Add buttonStyles here
            }}
            onClick={togglePlay}
          >
            <BsFillPlayFill
      ...
      {/* <img
        src={iPhoneXS}
        className=" absolute ml-[1028px] mt-[279px] w-[399px] h-[779px]"
      /> */}
      ...
      <span className=" absolute font-bold text-[89px] leading-[120px] text-white ml-[340px] mt-[190px]">
        Production
      </span>
      <Button className=" absolute bg-primary  text-[16px] text-white flex font-inter py-[0px] px-[15px] ml-[659px] mt-[300px]  w-[129px] h-[26px]">
        Что входит&nbsp;
      </Button>

      <ul className=" absolute text-white font-normal text-[18px] leading-[24px] text-opacity-80 ml-[360px] mt-[370px] list-disc ">
      ...
      <Button className="absolute rounded-md w-[190px] h-[41px] bg-transparent text-[16px] text-zinc-400 font-normal flex items-center justify-center border-white border mt-[590px] ml-[345px]">
        Больше примеров
      </Button>
      <Button className=" absolute font-semibold bg-primary text-[23px] text-white font-inter mt-[650px] ml-[345px] w-[319px] h-[55px]">
        Рассчитать стоимость
      </Button>

      <Footer2 className=" absolute mt-[835px] ml-[700px]  " />
    </div>
  );
};
